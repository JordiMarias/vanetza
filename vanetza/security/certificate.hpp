...
namespace security
{
    ...
    class Certificate{
        public:
            Certificate();
            Certificate(EtsiTs103097Certificate_t& certificate);
            Certificate(std::string certificate);
            //Certificate(Certificate& certificate);
            //Certificate(Certificate&& certificate);

            ~Certificate();
            uint8_t version() const { return 3; }
            //All the getters will be written with the verify service
            //All the setters will be written with the sign service
